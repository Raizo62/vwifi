...
- If building from a Git tag: uses the tag version (e.g., v6.3.0)
- If building from Git but not on a tag: uses git describe output (e.g., v6.3.0-5-g3d4f9a2)
- If building without Git: uses fallback version (e.g., 6.3.0-dev)
